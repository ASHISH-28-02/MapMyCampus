...
BUILDINGS = {
    ...
    "Residence Block C1, IISER TVM": {"lat": 8.685490511519728, "lng": 77.1264902852442, "description": "Residence Block provides residence to the faculty for easier commute to the campus.", "aliases": ["c1 quarters", "residence c1"]},
    ...
    "Director’s Bungalow": {"lat": 8.686551221770518, "lng": 77.12820691906941, "description": "The Director's Bungalow.", "aliases": ["director's bungalow"]},
