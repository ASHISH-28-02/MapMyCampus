...
// NEW: Function to find and drop a marker on a hotspot
function dropMarkerOnHotspot(query) {
    ...
    if (foundHotspot) {
        // Move the marker to the found hotspot's slot and make it visible
...
modelViewer.addEventListener('load', () => {
    ...
    hotspots.forEach((hotspot) => {
        ...
        // Re-implementing the old hover/focus logic from user's snippet
